...
```{r function1 modified, error=TRUE, message=TRUE}
# MODIFIED
...
```{r function2 modified, error=TRUE, message=TRUE}
# MODIFIED
name <- function(variables) {
...
```{r common_snip modified, error=TRUE, message=TRUE}
# MODIFIED
library(package)
...
```{r header_snip, error=TRUE, message=TRUE}
######################################################################
#
